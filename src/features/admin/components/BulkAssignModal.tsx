...
import { Modal, Box, Typography, Button, Stack, FormControl, InputLabel, Select, MenuItem, Chip } from "@mui/material";

export default function BulkAssignModal({ open, onClose, selectedUsers, roles, onAssign }) {
    ...
    <Modal open={open} onClose={onClose}>
      <Box sx={{
        ...
        <Typography variant="body2" mb={2}>
          You are about to assign a role to {selectedUsers.length} selected users.
        </Typography>
